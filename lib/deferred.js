    ...
    Y = definition();
     ...
     Y.when = function(value){
       ...
       if (value && typeof value.then === 'function')
         //this works cuz resolve & reject are closures not methods
         value.then(d.resolve, d.reject)
       else
         d.resolve(value)
       return d.promise
     }
     ...
     function Promise(q){
       var promise = { then: createThen(q) }
       //var promise = { then: _then }
